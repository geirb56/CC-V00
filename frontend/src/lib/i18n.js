...
export const translations = {
  ...
  es: {
    ...
    workoutDetailExtended: { fastest: "Más rápido", slowest: "Más lento", average: "Promedio", simplifiedView: "Vista simplificada ({count} km total)", fast: "Rápido", normal: "Normal", slow: "Lento", avg: "prom", pacePerKm: "Ritmo por kilómetro", enhancedAnalysis: "Análisis mejorado", splitAnalysis: "Análisis de Splits", fastestKm: "Km más rápido", slowestKm: "Km más lento", paceDrop: "Caída de ritmo", consistency: "Consistencia", negativeSplitMessage: "¡Aceleraste al final!", heartRateAnalysis: "Análisis de frecuencia cardíaca", hrDrift: "Deriva cardíaca", watchHydration: "Vigila la hidratación", similarWorkouts: "sesiones similares", comparison: "Comparación", vs: "vs", goFurther: "Ir más lejos", askCoach: "Preguntar al coach", meaning: "Qué significa", recovery: "Recuperación", coachAdvice: "Consejo del coach", analyzing: "Analizando..." },
